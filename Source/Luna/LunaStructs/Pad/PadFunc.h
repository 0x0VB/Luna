...
Pad* GetPadSelf() { return (Pad*)lua_touserdata(L, 1); }
#pragma endregion

#pragma region Lua Functions
int LunaStruct::Pad::Constructor(lua_State* L)
{
	int T = lua_gettop(L);
	switch (T)
	{
...
int LunaStruct::Pad::Lerp(lua_State* L)
{
	auto self = GetPad(1);
	auto Other = GetPad(2);
...
int LunaStruct::Pad::__index(lua_State* L)
{
...
int LunaStruct::Pad::__newindex(lua_State* L)
{
...
int LunaStruct::Pad::__tostring(lua_State* L)
{
	auto self = GetPadSelf();
	std::string ToStr =
...
int LunaStruct::Pad::__add(lua_State* L)
{
...
int LunaStruct::Pad::__sub(lua_State* L)
{
	auto OType = LunaUtil::Type(2);
...
int LunaStruct::Pad::__mul(lua_State* L)
{
...
int LunaStruct::Pad::__div(lua_State* L)
{
...
int LunaStruct::Pad::__eq(lua_State* L)
{
...
int LunaStruct::Pad::__gc(lua_State* L)
{
	auto self = GetPadSelf();
	delete self;
	return 0;
...
int LunaStruct::Pad::Init(lua_State* L)
{
