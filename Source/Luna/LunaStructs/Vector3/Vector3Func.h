...
FVector3* GetV3Self() { return (FVector3*)lua_touserdata(L, 1); }
...
int LunaStruct::Vector3::Constructor(lua_State* L)
{
	auto X = GetFloat(1);
	auto Y = GetFloat(2);
	auto Z = GetFloat(3);
...
int LunaStruct::Vector3::SetMagnitude(lua_State* L)
{
...
int LunaStruct::Vector3::DistanceFrom(lua_State* L)
{
	auto self = GetVector3(1);
...
int LunaStruct::Vector3::DirectionTo(lua_State* L)
{
	auto self = GetVector3(1);
	auto Other = GetVector3(2);
...
int LunaStruct::Vector3::Magnitude(lua_State* L)
{
	auto self = GetVector3(1);
	lua_pushnumber(L, self.Magnitude());
	return 1;
}
int LunaStruct::Vector3::Project(lua_State* L)
{
	auto self = GetVector3(1);
	self.Project().Push();
	return 1;
}
int LunaStruct::Vector3::Rotate(lua_State* L)
{
	auto self = GetVector3(1);
...
int LunaStruct::Vector3::Normal(lua_State* L)
{
	auto self = GetVector3(1);
	self.Normal().Push();
	return 1;
}
int LunaStruct::Vector3::Nudge(lua_State* L)
{
	auto self = GetVector3(1);
	auto Other = GetVector3(2);
...
int LunaStruct::Vector3::ToInt(lua_State* L)
{
	auto self = GetVector3(1);
	NewVector3((float)(int)self.X, (float)(int)self.Y, (float)(int)self.Z);
	return 1;
}
int LunaStruct::Vector3::Unit(lua_State* L)
{
	auto self = GetVector3(1);
	self.Unit().Push();
	return 1;
}
int LunaStruct::Vector3::Lerp(lua_State* L)
{
	auto self = GetVector3(1);
	auto Other = GetVector3(2);
...
int LunaStruct::Vector3::To2D(lua_State* L)
{
	auto self = GetVector3(1);
	self.To2D().Push();
	return 1;
...
int LunaStruct::Vector3::__index(lua_State* L)
{
	auto self = GetV3Self();
...
int LunaStruct::Vector3::__newindex(lua_State* L)
{
	auto self = GetV3Self();
...
int LunaStruct::Vector3::__tostring(lua_State* L)
{
	auto self = GetVector3(1);
...
int LunaStruct::Vector3::__add(lua_State* L)
{
...
int LunaStruct::Vector3::__sub(lua_State* L)
{
	auto OType = LunaUtil::Type(2);
...
int LunaStruct::Vector3::__mul(lua_State* L)
{
...
int LunaStruct::Vector3::__div(lua_State* L)
{
	if (!lua_isnumber(L, 2)) LunaIO::ThrowError("Unable to multiply Vector3 by " + LunaUtil::Type(2) + ".");
...
int LunaStruct::Vector3::__unm(lua_State* L)
{
	auto self = GetVector3(1);
	(-self).Push();
	return 1;
}
int LunaStruct::Vector3::__eq(lua_State* L)
{
...
int LunaStruct::Vector3::__gc(lua_State* L)
{
	auto self = GetV3Self();
	delete self;
	return 0;
...
int LunaStruct::Vector3::Init(lua_State* L)
{
