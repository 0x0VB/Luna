...
Color* GetColorSelf() { return (Color*)lua_touserdata(L, 1); }
#pragma endregion

#pragma region Lua Functions
int LunaStruct::Color::RGBConstructor(lua_State* L)
{
	auto R = GetInt(1, 0);
	auto G = GetInt(2, 0);
	auto B = GetInt(3, 0);
...
int LunaStruct::Color::HSVConstructor(lua_State* L)
{
	auto H = GetInt(1, 0);
	auto S = GetInt(2, 0);
	auto V = GetInt(3, 0);
...
int LunaStruct::Color::HexConstructor(lua_State* L)
{
...
int LunaStruct::Color::Lerp(lua_State* L)
{
...
int LunaStruct::Color::GetHex(lua_State* L)
{
	auto self = GetColor(1);
	lua_pushstring(L, self.GetHex().c_str());
	return 1;
}
int LunaStruct::Color::Negate(lua_State* L)
{
	auto self = GetColor(1);
	self.Negate().Push();
	return 1;
}
int LunaStruct::Color::GetHSVA(lua_State* L)
{
	auto self = GetColor(1);
...
int LunaStruct::Color::ShiftHue(lua_State* L)
{
	auto self = GetColor(1);
...
int LunaStruct::Color::Desaturate(lua_State* L)
{
	auto self = GetColor(1);
...
int LunaStruct::Color::__index(lua_State* L)
{
...
int LunaStruct::Color::__newindex(lua_State* L)
{
...
int LunaStruct::Color::__tostring(lua_State* L)
{
	auto self = GetColorSelf();
	std::string ToStr =
...
int LunaStruct::Color::__add(lua_State* L)
{
...
int LunaStruct::Color::__sub(lua_State* L)
{
	auto OType = LunaUtil::Type(2);
...
int LunaStruct::Color::__unm(lua_State* L)
{
	auto self = GetColorSelf();
	self->Negate().Push();
	return 1;
}
int LunaStruct::Color::__eq(lua_State* L)
{
...
int LunaStruct::Color::__gc(lua_State* L)
{
	auto self = GetColorSelf();
	delete self;
	return 0;
...
int LunaStruct::Color::Init(lua_State* L)
{
