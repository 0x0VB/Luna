...
DVector2* GetV2Self() { return (DVector2*)lua_touserdata(L, 1); }
...
int LunaStruct::Vector2::Constructor(lua_State* L)
{
	auto X = GetDouble(1);
	auto Y = GetDouble(2);
	NewVector2(X, Y);
...
int LunaStruct::Vector2::SetMagnitude(lua_State* L)
{
...
int LunaStruct::Vector2::DistanceFrom(lua_State* L)
{
	auto self = GetVector2(1);
...
int LunaStruct::Vector2::DirectionTo(lua_State* L)
{
	auto self = GetVector2(1);
	if (LunaUtil::Type(2) == "Vector3")
	{
...
int LunaStruct::Vector2::Magnitude(lua_State* L)
{
	lua_pushnumber(L, GetVector2(1).Magnitude());
	return 1;
}
int LunaStruct::Vector2::Rotate(lua_State* L)
{
	(GetVector2(1) % GetFloat(2)).Push();
	return 1;
}
int LunaStruct::Vector2::Normal(lua_State* L)
{
	(GetVector2(1).Normal()).Push();
	return 1;
}
int LunaStruct::Vector2::Nudge(lua_State* L)
{
	auto self = GetVector2(1);
	if (LunaUtil::Type(2) == "Vector3")
	{
...
int LunaStruct::Vector2::ToInt(lua_State* L)
{
	auto self = GetV2Self();
	self->ToInt().Push();
	return 1;
}
int LunaStruct::Vector2::Unit(lua_State* L)
{
	(GetVector2(1).Unit()).Push();
	return 1;
}
int LunaStruct::Vector2::Lerp(lua_State* L)
{
	auto self = GetVector2(1);
	if (LunaUtil::Type(2) == "Vector3")
	{
...
int LunaStruct::Vector2::To3D(lua_State* L)
{
	auto self = GetV2Self();
...
int LunaStruct::Vector2::__index(lua_State* L)
{
	auto self = GetV2Self();
...
int LunaStruct::Vector2::__newindex(lua_State* L)
{
	auto self = GetV2Self();
...
int LunaStruct::Vector2::__tostring(lua_State* L)
{
	auto self = GetVector2(1);
...
int LunaStruct::Vector2::__add(lua_State* L)
{
...
int LunaStruct::Vector2::__sub(lua_State* L)
{
	auto OType = LunaUtil::Type(2);
...
int LunaStruct::Vector2::__mul(lua_State* L)
{
...
int LunaStruct::Vector2::__div(lua_State* L)
{
...
int LunaStruct::Vector2::__unm(lua_State* L)
{
	(-GetVector2(1)).Push();
	return 1;
}
int LunaStruct::Vector2::__eq(lua_State* L)
{
...
int LunaStruct::Vector2::__gc(lua_State* L)
{
	auto self = GetV2Self();
	delete self;
	return 0;
...
int LunaStruct::Vector2::Init(lua_State* L)
{
